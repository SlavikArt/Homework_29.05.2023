...
TOKEN = "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" # Его можно получить здесь https://github.com/settings/tokens
g = Github(TOKEN)
...
def getData():
    ...
    if "Homework" in heading:
        main_description = "Д/з: " + input("Введите описание, Д/з: ")
    elif "Practice" in heading:
        main_description = "Практика: " + input("Введите описание, Практика: ")
    data.update({"Main description": main_description})

    # Projects description
    for folder in os.listdir():
        if os.path.isdir(folder) and ("_" in folder or folder == "main"):
